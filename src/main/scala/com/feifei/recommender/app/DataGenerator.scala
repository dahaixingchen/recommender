...
object DataGenerator{
  def main(args: Array[String]) {
    ...
    makelist(10000,"d:/recommonder") // 应用词表,
    makeappdown(10000,"d:/recommonder") // 用户历史下载,主题,是一个应用,游戏中心,是一个应用,应用中心,是一个应用
    makesample(10000,"d:/recommonder")  // 模拟正负例样本  = 浏览记录+lable
  }
  /**
    模拟app的商品词表
  ...
  /**
    ...
    * 正负例样本表 = 浏览记录+标签
    label       STRING,        Y列，-1或1代表正负例    label值实际上是批处理得出来的，用户浏览了并在一段时间内下载为1,未下载为-1
